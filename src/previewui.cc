...
void initPreviewMode(DrumMachine &dm)
{
  ...
  triggerPreviewSample(dm, 'a' - 1);
  dm.previewData.previewDirty = true;
  dm.previewData.lastSample = 'q';
...
// trigger the audio for a sample
